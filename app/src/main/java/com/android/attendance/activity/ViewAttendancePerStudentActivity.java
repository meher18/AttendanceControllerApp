...
public class ViewAttendancePerStudentActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editText=findViewById(R.id.delete_date);
		editText1=findViewById(R.id.delete_subject);
		button=findViewById(R.id.deleteAttendance);
		button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				dbAdapter.deleteAttendance(date.trim(),subject);
			}
		});
...
//    getSupportFragmentManager().beginTransaction().add(R.id.fragment_container,new viewAttendanceByDateFragment()).commit();
