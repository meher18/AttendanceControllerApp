...
public class AddStudentActivity extends Activity {
	...
	private String[] yearString = new String[] {"1st","2nd","3rd","4th","5th","6th","7th","8th"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textRegistrationNo =(EditText)findViewById(R.id.editTextLastName);
		...
		registerButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String last_name = textRegistrationNo.getText().toString();
				...
				if (TextUtils.isEmpty(first_name)) {
					...
					textRegistrationNo.setError("please enter Registration No");
				}
